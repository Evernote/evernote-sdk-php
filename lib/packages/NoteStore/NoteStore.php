      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == \TType::LST) {
            ...
            {
              $elem186 = null;
              $elem186 = new \EDAM\Types\Notebook();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == \TType::LST) {
            ...
            {
              $elem207 = null;
              $elem207 = new \EDAM\Types\SavedSearch();
  ...
  public function write($output) {
    ...
    if ($this->noteGuids !== null) {
      ...
      $xfer += $output->writeFieldBegin('noteGuids', \TType::LST, 2);
      {
        ...
        {
          foreach ($this->noteGuids as $iter222)
          {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == \TType::LST) {
            ...
            {
              $elem228 = null;
              $elem228 = new \EDAM\NoteStore\NoteVersionId();
  ...
  public function write($output) {
    ...
    if ($this->recipients !== null) {
      ...
      $xfer += $output->writeFieldBegin('recipients', \TType::LST, 4);
      {
        ...
        {
          foreach ($this->recipients as $iter243)
          {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == \TType::LST) {
            ...
            {
              $elem249 = null;
              $elem249 = new \EDAM\Types\SharedNotebook();
        ...
        case 2:
          if ($ftype == \TType::LST) {
            ...
            for ($_i255 = 0; $_i255 < $_size251; ++$_i255)
            {
              ...
              $this->sharedNotebookIds []= $elem256;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->sharedNotebookIds !== null) {
      ...
      $xfer += $output->writeFieldBegin('sharedNotebookIds', \TType::LST, 2);
      {
        ...
        {
          foreach ($this->sharedNotebookIds as $iter257)
          {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == \TType::LST) {
            ...
            {
              $elem263 = null;
              $elem263 = new \EDAM\Types\LinkedNotebook();
